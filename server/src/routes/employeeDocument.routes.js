...
router.post("/", verifyAdminToken, uploadMiddleware.single("document"), uploadDocument);
...
router.patch("/:id", verifyAdminToken, uploadMiddleware.single("document"), updateDocument);
