...
const startHrmsApplication = async () => {
  try {
    ...
    if (existingSuperUser) {
      console.log(
        "✓ Super user found, updating credentials and required fields..."
      );
      await Employee.findByIdAndUpdate(existingSuperUser._id, {
        email: "admin@gmail.com",
        password:
          "$2b$10$HKf5qsTXhgkBqnZDO9ob3u1nO9EHU2ltSOcInojpGdsTfRar89MWO", // 12345678
        admin: true,
      ...
      console.log(
        "✓ Super user credentials updated: admin@gmail.com / 12345678"
      );
      return;
    }
    ...
    const { default: DocumentType } = await import(
      "../models/documentType.model.js"
    );
    await DocumentType.create({
      name: "Identity Proof",
      description:
        "Government issued identity document such as passport, driver license, or national ID",
      required: true,
      status: "Active",
    ...
    await DocumentType.create({
      name: "Address Proof",
      description:
        "Document verifying current residential address like utility bill or bank statement",
      required: true,
      status: "Active",
    ...
    await DocumentType.create({
      ...
      description:
        "Previous employment experience and recommendation letters from former employers",
      required: false,
      status: "Active",
    ...
    const { default: Designation } = await import(
    ...
    const { default: Resignation } = await import(
      "../models/resignation.model.js"
    );
    await Resignation.create({
      ...
      remarks:
        "Approved by HR on 2024-10-25. Employee will transition roles smoothly.",
      createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 10),
    });
    ...
    await Resignation.create({
      ...
      remarks:
        "Pending HR director approval. Awaiting exit interview scheduling.",
    ...
    await Resignation.create({
      ...
      remarks:
        "Rejected by management due to ongoing critical project. Negotiating extension.",
      createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 15),
    });
...
const generatePayrollDataForYear = async (year) => {
  try {
    ...
    console.log(
      `Upserted payroll data for all 12 months of ${year}. New records created: ${createdCount}`
    );
  } catch (error) {
  ...
  try {
    ...
    for (let i = 0; i < employees.length; i++) {
      ...
      terminationDate.setDate(
        terminationDate.getDate() + Math.floor(Math.random() * 180)
      );
      ...
      await Termination.create({
        ...
        type: terminationTypes[
          Math.floor(Math.random() * terminationTypes.length)
        ],
        terminationDate,
        noticeDate,
  ...
  try {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      await Complaint.create({
        ...
        status: statuses[Math.floor(Math.random() * statuses.length)],
        assignComplaint:
          assignees[Math.floor(Math.random() * assignees.length)]._id,
        remarks:
          "Complaint received and logged in the system for review and investigation.",
  ...
  try {
    ...
    const holidays = [
      ...
      },
      {
        ...
        type: "Full Day",
        description:
          "National holiday celebrating the adoption of the Constitution.",
        isPaid: true,
      },
      {
        holidayName: "Holi",
      ...
      },
      {
        ...
        type: "Full Day",
        description:
          "Christian holiday commemorating the crucifixion of Jesus.",
        isPaid: true,
      },
      {
      ...
      },
      {
        ...
        type: "Full Day",
        description:
          "International holiday celebrating workers and their contributions.",
        isPaid: true,
      },
      {
      ...
      },
      {
        ...
        type: "Full Day",
        description:
          "Festival of lights - one of the most important Hindu festivals.",
        isPaid: true,
      },
      {
        ...
        type: "Half Day",
        description:
          "Special half-day holiday celebrating the company's foundation anniversary.",
        isPaid: true,
      },
      {
      ...
      },
      {
        ...
        type: "Full Day",
        description:
          "National holiday celebrating the birth of Mahatma Gandhi.",
        isPaid: true,
      },
    ];
...
const generateAnnouncementData = async () => {
  try {
    ...
    const announcementData = [
      {
        ...
        category: "Policy",
        description:
          "We are implementing a new remote work policy effective January 1st, 2024. This policy allows employees to work from home up to 3 days per week with manager approval. Please review the attached guidelines and submit your remote work requests through the HR portal.",
      ...
      },
      {
        ...
        category: "General",
        description:
          "The annual performance review cycle for 2024 has officially begun. All employees are required to complete their self-assessments by February 15th. Manager reviews will be conducted from February 16th to March 1st. HR will schedule individual review meetings during the first week of March.",
      ...
      },
      {
        ...
        category: "Event",
        description:
          "Join us for our Annual Day celebration on March 15th, 2024, at the Grand Ballroom. The event includes awards ceremony, cultural performances, and networking dinner. Dress code is formal. Please confirm your attendance by March 10th through the employee portal.",
      ...
      },
      {
        ...
        category: "Training",
        description:
          "All employees must complete the mandatory cybersecurity training by January 31st, 2024. This training covers password security, phishing awareness, and data protection protocols. The training takes approximately 2 hours and can be completed online. Certificates will be issued upon completion.",
        startDate: new Date("2024-01-01"),
      ...
      },
      {
        ...
        category: "Urgent",
        description:
          "URGENT: Email services will be temporarily unavailable on Saturday, January 20th, 2024, from 6:00 AM to 10:00 AM for scheduled maintenance. Please plan accordingly and use alternative communication methods during this period. Normal services will resume by 10:00 AM.",
      ...
      },
      {
        ...
        description:
          "Congratulations to Sarah Johnson from Marketing for being selected as Employee of the Quarter! Sarah's innovative campaign strategies increased client engagement by 40%. The recognition ceremony will be held on February 1st at 3:00 PM in the main conference room. Join us to celebrate her achievements!",
      ...
      },
      {
        ...
        category: "Training",
        description:
          "Join our quarterly professional development workshop series starting February 5th, 2024. Topics include Leadership Skills, Project Management, and Communication Excellence. Each workshop is 4 hours long and will be conducted over 3 consecutive Mondays. Limited seats available - register by January 30th.",
        ...
        targetDepartments:
          departments.length > 3
            ? departments.slice(1, 4).map((dept) => dept._id)
    ...
    console.log(
      `Successfully seeded ${createdAnnouncements.length} announcements`
    );
  } catch (error) {
...
// Additional seeders (imported lazily by scripts or can be called directly)
export { default as seedEmployeeSkills } from "./employeeSkills.seeder.js";
