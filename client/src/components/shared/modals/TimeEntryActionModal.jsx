...
const TimeEntryActionModal = ({ isOpen, action, entry, onClose, onApprove, onReject }) => {
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          {/* Header */}
          <div className={`px-6 py-4 ${action === 'approve' ? 'bg-green-500' : 'bg-red-500'}`}>
          ...
          <div className="px-6 py-4 bg-white dark:bg-gray-800">
            ...
            <div className="mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Time Entry Details</h4>
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-gray-100">{entry?.project || '-'}</p>
                </div>
                <div>
            ...
            <div className={`p-3 rounded-lg ${action === 'approve' ? 'bg-green-50 dark:bg-green-900/20' : 'bg-red-50 dark:bg-red-900/20'}`}>
              <p className={`text-sm ${action === 'approve' ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'}`}>
                {action === 'approve'
