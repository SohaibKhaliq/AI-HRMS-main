...
import { FaTimes, FaCheck, FaBan, FaCalendarAlt, FaMapMarkerAlt, FaClock } from 'react-icons/fa';
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
        {/* Header */}
        <div className={`flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700 ${isAccept ? 'bg-green-50 dark:bg-green-900' : 'bg-red-50 dark:bg-red-900'}`}>
          <h3 className={`text-lg font-semibold ${isAccept ? 'text-green-800 dark:text-green-300' : 'text-red-800 dark:text-red-300'}`}>
